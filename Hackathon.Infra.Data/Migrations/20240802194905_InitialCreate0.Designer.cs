...
namespace Hackathon.Infra.Data.Migrations
{
    ...
    [Migration("20240802194905_InitialCreate0")]
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            AppointmentDate = new DateTime(2024, 8, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DoctorId = 1,
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AlterDate = new DateTime(2024, 8, 2, 16, 49, 4, 555, DateTimeKind.Local).AddTicks(5600),
                            CreateDate = new DateTime(2024, 8, 2, 16, 49, 4, 555, DateTimeKind.Local).AddTicks(5591),
                            Description = "Doctor"
                        },
                        new
                        {
                            Id = 2,
                            AlterDate = new DateTime(2024, 8, 2, 16, 49, 4, 555, DateTimeKind.Local).AddTicks(5603),
                            CreateDate = new DateTime(2024, 8, 2, 16, 49, 4, 555, DateTimeKind.Local).AddTicks(5602),
                            Description = "Patient"
                        });
                });
            ...
            modelBuilder.Entity("Hackathon.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$eL05H1cLwy08PrehyOjaTuz8QKvnHcm1J9r/U7IbtzkUveDRYwTYO",
                            PersonId = 1
                        },
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$iD93J4.XWpTWraXnzK0PnO73/Kt9dH2t74Kb.Le9NRKFFM9xUt/Lq",
                            PersonId = 2
                        });
                });
